...
| `niri-shm-sharing` | `26.04-2` | A scrollable-tiling Wayland compositor with SHM/MemFd fallback patch for PipeWire screencasting | [AUR](https://aur.archlinux.org/packages/niri-shm-sharing) |
| `yakit-bin` | `1.4.8_0703-1` | Cyber Security ALL-IN-ONE Platform (official AppImage release) | [AUR](https://aur.archlinux.org/packages/yakit-bin) |
<!-- packages:end -->
